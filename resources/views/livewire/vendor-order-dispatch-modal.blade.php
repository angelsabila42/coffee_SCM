                            ...
                            <div>
                                @error('quantity') <span class="error">{{ $message }}</span> @enderror
                                            ...
                                            <div class= "row ml-25">
                                                ...
                                                <div class="form-group pl-4 w-50">
                                                    <label for="dateDispatched">Date Dispatched</label>
                                                    <input type="date" class="form-control" id="dateDispatched" wire:model="dateDispatched">
                                                        <div>
                                                            @error('dateDispatched') <span class="error">{{ $message }}</span> @enderror
                                                        </div>
                                                </div>    
                                            </div>
                                            ...
                                            <div class= "row mr-2">
                                            <button  class="btn save mr-2" type="submit" >Submit
                                                    <div wire:loading>
