                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('store.vendor') }}">
                        ...
                        <div style="display: flex">
                             <label for="pdf_application" class="col-md-4 col-form-label text-md-end">{{ __('pdf_application') }}</label>

                         <input id="pdf_application" type="file" class="form-control @error('pdf_application') is-invalid @enderror" name="pdf_application" required >
