    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('store.transporter') }}" >
                        @csrf

                         <div class="row mb-3">
                            <label for="name" class="card-title col-md-4 col-form-label text-md-end">{{ __('Full name') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="co_name" class="card-title col-md-4 col-form-label text-md-end">{{ __('Company name') }}</label>

                            <div class="col-md-6">
                                <input id="co_name" type="text" class="form-control @error('co_name') is-invalid @enderror" name="co_name" value="{{ old('co_name') }}" required autocomplete="co_name">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="phone_number" placeholder="start with 07" placeholder="start with 07" type="number" class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" value="{{ old('phone_number') }}" required autocomplete="phone_number">
                        ...
                        --}}
                         <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary rounded-pill w-50 mt-3">
                                    {{ __('Save') }}
                                </button>
                            </div>
                        </div>
