    ...
    <div class="row">
        <div class="col-12 mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <h2 class="fw-bold mb-0">Quality Assessment Report</h2>
                <a href="{{ route('qa.index') }}" class="btn btn-light">Back to List</a>
            </div>
        </div>
        <div class="col-md-12">
            <div class="card">                <div class="card-body">
                    ...
                    <div class="final-assessment mb-5">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <button type="button" class="btn btn-primary" onclick="window.location.href='{{ route('qa.index') }}'">Back to Reports</button>
                        </div>
                    @endif
                </div>
            </div>
